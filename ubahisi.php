...
$ubah = query("SELECT * FROM belajar WHERE judul = $judul")[0];
...
<html lang="en">
  ...
  <body>
    ...
    <main role="main" class="flex-shrink-0">
      <div class="container">
        <h1 class="mt-5">Ubah Materi</h1>
        <form action="" method="post" enctype="multipart/form-data">

          <label for="judul" class="sr-only">Judul Pelajaran</label>
          <input type="text" id="judul" class="form-control" placeholder="Masukkan Judul" value="<?= $ubah["judul"];?>" name="judul" required autofocus>
          <br>
          ...
          <br>
          <button class="btn btn-lg btn-primary btn-block" type="login" name="ubah">Ubah</button>  
        </form>
      </div>
    </main>
