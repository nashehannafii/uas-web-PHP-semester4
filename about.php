  ...
  <body>
    ...
    <header class="row tm-welcome-section">
        <div class="container text-center about">
            <img class="rounded" src="img/nasheh.png" alt="" width="300px">
        </div>
        <h2 class="col-12 text-center tm-section-title"><b>Web Developer</b></h2>
        
        <p class="col-12 text-center">Moch. Nasheh An Nafii. <br> Mahasiswa teknik informatika Universitas Darussalam Gontor. <br> Email : <a rel="nofollow" href="https://gmail.com"> nashehannafii@unida.gontor.ac.id</a></p>
    </header>

    <footer class="footer mt-auto py-3">
        <div class="container text-center">
        <span class="text-muted"><p>Copyright &copy; 2021 Nasheh An Nafii | Source: <a href="https://informatika.unida.gontor.ac.id">Informatika UNIDA</a></p></span>
        </div>
    </footer>
